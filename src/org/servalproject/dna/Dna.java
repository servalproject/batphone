...
public class Dna {
	...
	private void receivePacket() throws IOException, IllegalAccessException, InstantiationException{
	...
	private void processAll() throws IOException, IllegalAccessException, InstantiationException{
